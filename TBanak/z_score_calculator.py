...
# Load data
data_laki_pb_u = pd.read_excel("TBanak/Anak_laki_PB_U_umur_0-24_pengukuran_terlentang.xlsx")
data_perempuan_pb_u = pd.read_csv("TBanak/Panjang_Badan_Menurut_Umur_Perempuan_0-24 bulan.csv")
data_perempuan_tb_u = pd.read_csv("TBanak/Tinggi_Badan_menurut_umur_Perempuan_24-60 umur_pengukuran berdiri.csv")
data_laki_tb_u = pd.read_excel("TBanak/Tinggi_Badan_Umur_24_60_Bulan_Laki.xlsx")
